...
test('welcome all preserves individual training and saves without granting village rewards',()=>{
 let s=fresh(1000),rate=totalRate(s);s=run(s,'adoptFamiliar','Pet_1191').state;s=run(withItems(s),'trainFamiliar','Pet_1191',10).state;s=run(withItems(s),'starFamiliar','Pet_1191').state;
