...
test('all 516 admitted animations match exact appearance ownership and bytes',()=>{
 ...
 assert.equal(baseCount,259);assert.equal(costumeCount,257);assert.equal(total,536612208);assert.equal(clips.wife_1.sha256,'92ed49260a4a01e806f3a269d081701d82804268962659d6ff3304b0302009e8');assert.equal(clips.hero_1.sha256,'76f09d7f749df601757ed4c701fb6c85d31684ab19ea0b16cf5c88a70692bf11');
});
