...
import {insightRule,insightState,insightTrainingPlan} from '../lib/insight.mjs';
...
test('legacy30 saves gain no automatic levels or rewards and may explicitly train beyond30',()=>{
 let s=stock(fresh(1000));s.insight.levels.hero_15=30;s.fellows.hero_15.aptitude=137;const copy=structuredClone(s);s=decode(JSON.stringify(s));assert.deepEqual(s,copy);
