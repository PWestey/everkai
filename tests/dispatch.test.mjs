...
const ALLOWED=new Map([
 ...
 ['adoptFamiliar','ECON-11 (2026-09-16): free familiar acquisition, now a test fixture only. Players get familiars from the starter choice (familiarStarter), contracts while Exploring (exploreCatch) and Familiar Tower floor rewards. About twenty test files build fixtures with it, the same call as `recruit`.'],
 ['adoptFamiliars','ECON-11 (2026-09-16): grants all 71 familiars free; test fixture only, like recruitAll.'],
