...
const stock=(s,id)=>{const i=insightState(s),k=insightRule(id).materialId;return {...s,insight:{...i,balances:{...i.balances,[k]:(i.balances[k]||0)+1000}}};};
