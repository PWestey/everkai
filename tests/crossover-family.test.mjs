...
test('the installed media matches its recorded bytes and hashes, and streams rather than precaching',()=>{
 ...
 // MOVED 2026-09-23, DOWN by 3,197,063: 8 of these 30 sit in bundles whose COMPRESSED skin UnityPy
 // mis-decodes (scripts/crossover/unity_to_glb.py compressed_skin), so they were re-rendered with
 ...
 // MOVED 2026-09-23 by the material pass, DOWN 1,232,962: 12 of these 30 are SWGOH.
 assert.equal(bytes,36869434,`the 30 Family add ${bytes} bytes`);
