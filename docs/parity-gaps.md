...
|---|---|---|
| **Roaming / strolling town encounters** (Family acquisition, drink events, item drops) | **ABSENT** | No `roam`/`stroll` in app/lib. SYSTEMS.md:67 "roaming encounters … pending". Original Drakenberg "Roaming" building (drakenberg-layout.json provenance). |
...
|---|---|---|---|---|
| 1 | Roaming / strolling encounters | ABSENT | Whole system; Family acquisition route | — (SYSTEMS.md:67) |
