...
app=Path(__file__).resolve().parents[1];w=WORKSPACE;p=w/'outputs/component-research/datasets/Rule.json';ip=w/'outputs/component-research/datasets/Item.json';items={r['id']:r['en'] for r in json.loads(ip.read_text())};id='Item_Gcoin_YieldPack_1';assert items['Item:name:'+id]=='Basic Earnings Card'
