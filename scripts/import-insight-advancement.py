...
e=json.loads((WORK/'isekai-research/notes/insight-advancement-rows.json').read_text())
rows=e['rows']
...
mastery=json.loads((WORK/'isekai-research/notes/default-advancement-mastery.json').read_text())
m=mastery['insightI']
