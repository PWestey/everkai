...
out={'snapshot':'b49c78d0c06d535f6e1c62bdc9d5d666cd96e954','source':'https://zik-ascend.github.io/isl-tools/wiki/inn/','sha256':hashlib.sha256(raw).hexdigest(),'stations':stations,'dishes':dishes,'localRules':rules,'sandbox':{'buildGoldPerStationId':100,'upgradeBlueprints':'current station level','stationCap':20,'guestStamina':1,'serviceMs':10000,'guestGold':50,'guestBlueprints':1,'guestFinesse':1,'staminaRefill':20,'queueCap':10,'recipeTasks':'waived, retain source guest/station gates'}}
