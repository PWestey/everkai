...
types={'Inn':'Diligent','Apothecary':'Informed','Workshop':'Brave','Scroll Shop':'Inspiring','Spring Resort':'Unfettered','Central Station':'Inspiring','Patisserie':'Diligent','Archery Range':'Brave','Clinic':'Informed','Market Street':'Unfettered','Bank':'Inspiring','Tailor Shop':'Diligent','Sports Park':'Brave','Museum':'Informed','Theater':'Unfettered','Airship':'Inspiring','Magic Academy':'Diligent'}
records=[]
...
data={'localSource':'Readable English UnityFS translation TextAsset, APK 1.7702 source set','localSha256':hashlib.sha256(raw).hexdigest(),'publicSources':['https://isekai.wiki/index.php?title=Building_Operations&oldid=1487','https://isekai.wiki/Village'],'inspected':'2026-09-07','operationScope':{'expression':'sum(owned Fellow Power)/1000','confidence':'community-corroborated, underlying Power reconstructed','sources':['https://www.reddit.com/r/Isekai_Slow_Life/comments/17bq81z/','https://www.reddit.com/r/Isekai_Slow_Life/comments/1k7n80f/'],'localSourceKey':'UI_Lobby_Panel_PanelBuildingTips_n25'},'costSource':{'file':'BuildingBase.json','sha256':hashlib.sha256(basesRaw).hexdigest(),'field':'consume where item id 3 (Gold)','note':'Opening prices, order and cityLandId are the original table\'s own values. The campaign packet behind lib/opening-data.json carries only the four opening-chapter buildings.'},'typeSource':{'file':'BuildingBase.json','sha256':hashlib.sha256(basesRaw).hexdigest(),'field':'country','note':"The 15 typed rows came from the translation TextAsset, which does not carry country. Building_1601 (Airship) and Building_1701 (Magic Academy) were left null there and are filled from BuildingBase.country, which maps 1:1 onto this file's type across all 15 already-typed rows: 1 Inspiring, 2 Diligent, 3 Brave, 4 Informed, 5 Unfettered. Airship is country 1, Magic Academy country 2. This matters because the original targets 510 of its 540 appoint-skill instances at country, and fellowOperation matches on this field."},'slotThresholds':[0,50,200,800,5000],'records':records}
