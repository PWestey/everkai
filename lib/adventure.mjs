...
export function powerParts(s,id){
 ...
 const flat={family:b.flat,fishing:fish.flat,stella:st.flat,elixir:elixirPower(s,id),familiar:pet.flat,museum:m.flat};
