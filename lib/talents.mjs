...
export const talentCap=(s,id)=>(originalProgression(s)&&talentPaidCap(id)&&talentRule(id)?source.paidCap:talentRule(id)?.cap||0)+(talentRule(id)?stellaTalentLimit(s,id):0);
