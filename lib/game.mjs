...
export const startingSave=(now=Date.now())=>({...fresh(now),habits:starterHabits(now)});
...
export function newJourney(state,now=Date.now()){const base=fresh(now);return {...base,habits:state?.habits?{...state.habits}:starterHabits(now)}}
