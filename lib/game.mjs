...
export const VALIDATORS={validVillageEvents,validAchievements,validEvents,validHelper,validSupplyClaim,validHabits,validWardrobe,validFamilyGallery,validOpening,validMine,validStella,validNorthern,validRoaming,validSummon,validTradingPost,validStageEvent,validTonics,validElixirs,validFountain,validBanquets,validApothecary,validTreasure,validV4,validStory,validExpo,validTower,validFamiliarExplore,validFrontier,validInn,validWorkshop,validFarm,validHireCards,validBusinesses,validMuseum,validBlessings,validFamiliars,validStage,validAdventure,validTalentSkills,validHeroAdvance,validBonds,validFathoms,validFamilyTrips};
