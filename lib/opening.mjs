...
export function openingAction(s,action,target,value,income){
 ...
 else if(target==='Item_Building_Recruit_Increase_1'){const b=n.enterprises?.[value];if(!b||b.employees>=employeeCap)throw Error('Choose an open business with room below5000 staff.');n.enterprises[value]=addStaff(n,value,b,1);}
