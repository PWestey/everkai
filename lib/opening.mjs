...
export function validOpening(s){
 if(s?.opening===undefined)return true;const o=s.opening;if(!obj(o)||o.version!==1||!int(o.cleared,126)||!int(o.rank,MAX_RANK)||o.rank<1||!int(o.claimed,136)||!['fame','collections','education','fathoms','reforges','upgrades'].every(k=>int(o[k])))return false;
