...
import {decodeCampaign,CAMPAIGN,OPENING_STAGES,LAST_CHAPTER,openingQuote,openingBossReady} from './stage-ladder.mjs';
...
export {decodeCampaign,CAMPAIGN,OPENING_STAGES,LAST_CHAPTER,openingQuote,openingBossReady};
