...
const additions=(kind,existing)=>availability.filter(r=>r.status==='verified-base'&&r.id.startsWith(kind+'_')&&!existing.includes(r.id)).map(r=>({id:r.id,art:r.art,portrait:r.art,specialty:null}));
