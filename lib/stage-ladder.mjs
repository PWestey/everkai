...
//
// Chapters 1-3,000 of that table are already imported and hash-pinned in `opening-data.json`
// (chapters 1-6) and `campaign-chapters-data.json` (chapters 7-3,000, provenance carries the sha256
...
// another 2.4MB to the offline precache for rows the bundle already carries.
//
...
/** Every battle of chapters 1-3,000, in the original's own `stageId` order: 63,000 rows, 21 a chapter
...
// `levelBoss`, and the shipped rows agree: all 3,000 imported chapters have the shape
...
/** The village campaign: 18,000 stages, chapters 1-3,000, six stages a chapter, every 6th a boss.
 *  `atk` runs 1,350 at stage 1 to 1,191,000,000 at stage 18,000. */
