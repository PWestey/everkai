...
export function cloneExplore(s){const e=exploreState(s);return {...e,steps:{...e.steps},items:{...e.items},pieces:{...e.pieces},sp:[...e.sp],encounter:e.encounter&&{...e.encounter},pending:e.pending?{...e.pending}:null};}
...
export function exploreAction(s,action,target,value){
 if(!['familiarStarter','exploreArea','exploreStep','exploreResolve','exploreCatch','exploreSoothe'].includes(action))return null;
