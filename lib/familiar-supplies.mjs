...
export const towerIncome=s=>{const base=floorIncome(towerFloorOf(s)),e=endlessFloorOf(s),band=e?endlessBand(e):null;return band?{levelUp:base.levelUp+band.income[0],classUp:base.classUp+band.income[1]}:base;};
