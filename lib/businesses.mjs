...
export function businessBonus(s,id,b,definition){
 ...
 return {quality,family,farm,latency,total:assignedOperation(s,definition)+quality+family+farm+latency};
}
export function enterpriseBreakdown(s,id){
 ...
 const {quality:qualityBonus,family:familyBonus,farm:farmBonus,latency:latencyBonus,total:bonus}=businessBonus(s,id,b,definition);
 return {employees,operation,bonus,qualityBonus,familyBonus,farmBonus,latencyBonus,total:(employees+operation)*(1+bonus)};
}
