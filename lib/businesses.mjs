import {recordStaff,staffingStatus,staffingAction,staffPrice,validStaffing,validStaffingReserve} from './staffing.mjs';
...
export const ANY_BUILDING_FELLOWS=new Set(['hero_193','hero_53']);
...
export function hireQuote(s,id,n){
 ...
 const status=staffingStatus(id,b),ceiling=status?status.cap:employeeCap;
