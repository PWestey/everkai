...
export function businessBonus(s,id,b,definition){
 const quality=staffingStatus(id,b)?.bonus||0,family=fathomBonus(s,definition.type);
 return {quality,family,total:assignedOperation(s,definition)+quality+family};
}
export function enterpriseBreakdown(s,id){
 ...
 const {quality:qualityBonus,total:bonus}=businessBonus(s,id,b,definition);
