...
// Raised to the original ceiling 2026-09-15 (F12-02). The costs are the original's own, and ore is the real
// limit -- taking all 84 artifacts to 200 costs 1,004,950 ore against roughly 85/day -- so this lifts an
// invented ceiling without inventing supply.
export const ARTIFACT_CAP=200;
