...
export function frontierAction(s,action,target,value){
 ...
 if(s.gold+r.gold>1e12||s.fellowXP+r.xp>MAX_FELLOW_XP||s.crystals+r.crystals>1e9)return fail('Spend currency or EXP to make room for the full victory reward.');
