...
export const CROSSOVER_STELLA=Object.freeze({
 ...
 levels:Object.freeze(ANGIE.levels.map(r=>Object.freeze({level:r.level,cost:r.cost,itemId:CROSSOVER_SHARD_ITEM,flat:r.flat,percent:0,selfPowerBp:0,appointYieldBp:0,talentLimit:0}))),
