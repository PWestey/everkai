...
export function teamAttribute(s,team){
 // COMBAT_ADD weights, the same three PetAttr rows lib/familiar-dispatch.mjs uses. Taken directly
 // rather than imported: that module imports this one, and the cycle is not worth one multiply.
 let n=0;for(const id of team){const p=s.familiars?.[id];if(!p)continue;const st=familiarStats(id,p);n+=st.ATK*15+st.HP*1+st.SPD*30;}
