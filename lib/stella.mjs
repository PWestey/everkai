 ...
 *
 *  `b.percent` is now the SUM of the type-wide column and the owner's own-Power column (stellaBonus
 *  above), because the client keeps both in one `percent` bucket. Nothing about this line changed when
 *  the own column was imported on 2026-09-18 -- which is the point: a correctly-bucketed column needs
 *  no new multiplier, and adding one would have compounded two terms the original adds. */
