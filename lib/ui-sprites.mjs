...
export const cardStyle=rarity=>{const bg=petCardIcon(rarity||'N'),frame=petFrameIcon(rarity||'N');return {'--card-bg':bg?`url(${bg})`:undefined,'--card-frame':frame?`url(${frame})`:undefined}};
