...
import {crossoverBadgeQuality} from './crossover-abilities.mjs';
...
export function displayRarity(s,id){
 // The four starters (lib/crossover-abilities.mjs CROSSOVER_STARTERS) never show below their starting badge.
 if(rarityClimbs(id))return crossoverRarity(crossoverBadgeQuality(id,climbedQuality(s,id)));
...
export function withDisplayRarity(s,person){
 ...
 const rarity=crossoverRarity(crossoverBadgeQuality(person.id,climbedQuality(s,person.id)));
