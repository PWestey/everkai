...
export default function App(){
 ...
 return <main className="game">
  ...
  <VillageMap menuOpen={townMenu} setMenuOpen={setTownMenu} game={game} locked={locked} income={effectiveRate(game,game.lastAt).toFixed(1)} pending={fmt(game.pending)} collect={()=>action('collect')} openModule={openModule} openBusiness={(id:string)=>{setBusinessSelected(id);setBusinessVisit(n=>n+1);openModule('businesses',true)}}/>
  {primaryNavigation}
