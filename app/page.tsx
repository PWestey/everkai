...
export default function App(){
 ...
 const modules=[['habits','Habit journal'],['fellows','Fellows'],['family','Family'],['adventure','Adventure'],['supplies','Storage'],['businesses','Businesses'],['school','School'],['mine','Mine Clearance'],['northern','Northern Odyssey'],['roaming','Roaming'],['trading','Trading Post'],['fountain','Fountain of Wishes'],['banquets','Banquets'],['apothecary','Apothecary'],['museum','Museum'],['treasure','Treasure Hunt'],['fishing','Fishing'],['expo','Mushroom Expo'],['stories','Village stories'],['journey','Journey'],['raphael',"Raphael’s Stage"]];
