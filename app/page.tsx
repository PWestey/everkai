...
export default function App(){
 ...
 return <main className="game">
  <GameResources gold={game.gold} crystals={game.crystals} income={effectiveRate(game,game.lastAt)} multiplier={earningsMultiplier(game,game.lastAt)} onSettings={()=>setPanel(true)} rank={playerRank(game)} onProfile={()=>setProfile(true)}/><WayfarerProfile game={game} open={profile} onOpenChange={setProfile}/>
