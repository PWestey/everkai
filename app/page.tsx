...
export default function App(){
 ...
 return <main className="game">
  ...
  <VillageMap menuOpen={townMenu} setMenuOpen={setTownMenu} game={game} locked={locked} income={effectiveRate(game,game.lastAt).toFixed(1)} gold={fmt(game.gold)} openModule={openModule} openBusiness={(id:string)=>{setBusinessSelected(id);setBusinessVisit(n=>n+1);openModule('businesses',true)}}/>
  {primaryNavigation}
