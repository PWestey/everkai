...
export default function VillageMap({game,openBusiness,openModule,objective,locked,menuOpen,setMenuOpen}:any){
 ...
 </div></div>{objective}<DrakenbergTown open={menu} onOpenChange={setMenu} openModule={openModule}/></section>;
}
