...
export default function VillageMap({game,openBusiness,openModule,objective,helper,locked,menuOpen,setMenuOpen}:any){
 ...
 </div></div>{helper}{objective}<DrakenbergTown open={menu} onOpenChange={setMenu} openModule={openModule}/></section>;
}
