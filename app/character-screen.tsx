...
export default function CharacterScreen({person,collection,children,subtitle,stats=[],statBlock,primary,rail,info,infoOnly,heading,onPrevious,onNext}: {person:any,collection:ReactNode,children:ReactNode,subtitle?:string,stats?:{label:string,value:string|number}[],statBlock?:ReactNode,primary?:ReactNode,rail?:ReactNode,info?:ReactNode,infoOnly?:boolean,heading?:string,onPrevious?:()=>void,onNext?:()=>void}) {
 ...
 return <section className={'character-screen'+(hidden?' character-hidden':'')+(heading?' character-titled':'')} aria-label={person.name+' character screen'}>
